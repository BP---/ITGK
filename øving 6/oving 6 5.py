...
def intro_text():
    ...
    print('Ikke start svar med stor forbokstav, og bruk hele setninger.')
    print('skrv \'hade\' hvis du vil avslutte samtalen')
    print('*************************************************************\n')
...
def main():
  ...
  # Programmet kjører i løkke helt til brukeren svarer "hade"
    ...
    # MANGLER KODE HER!!!
        print_sentence(pick_sentence(responses), name, '.')
main()
